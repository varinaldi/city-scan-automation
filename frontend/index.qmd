...
chart_pga = addPlot(plots.population_growth)
...
chart_ubaa = addPlot(plots.urban_growth)
...
chart_lc = addPlot(plots.land_cover)
...
chart_pv = addPlot(plots.solar_pv)
...
chart_ee = addPlot(plots.earthquake)
html`<section class="level4">
...
chart_fwi = addPlot(plots.fire_weather_index)
