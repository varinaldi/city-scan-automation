...
if (!exists('flood_archive')) print_text(paste_bold('No flood archive data available')) else {
...
if (!exists('eq')) print_text(paste_bold('No earthquake data available')) else {
...
plots <- list.files("03-render-output/plots")
