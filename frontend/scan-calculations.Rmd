...
---
```{r initiate-message}
message("\n=== Running Scan-Calculation and Generating Charts ===\n")
```
#### Setup
...
## Flood Events
```{r flood-events, echo = F, message= F, warning=F}
...
## Earthquakes
```{r earthquake-events, echo = F, message= F, warning=F}
...
if (!exists('cyclones_near')) print_text(paste_bold('No cyclone data available')) else {
