...
gcs_base <- "/vsicurl/https://storage.googleapis.com/city-scan-global-public/Gridded_GDP_1990_2022"
...
if (!file.exists(gdp_tot_out)) {
  ...
  gdp_tot <- rast(paste0(gcs_base, "/rast_gdpTot_1990_2020_30arcsec.tif"))
...
if (!file.exists(gdp_pc_out)) {
  ...
  gdp_pc <- rast(paste0(gcs_base, "/rast_adm2_gdp_perCapita_1990_2022.tif"))
